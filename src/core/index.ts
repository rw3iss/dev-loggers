...
// LogModule is a type-only interface; `export type` is required under
// `isolatedModules: true` so transpilers strip the re-export cleanly.
export type { LogModule } from './lib/Sink.js';
